...
DEMO_LINES=(
    ": # Any thag script or expression can be saved as a command by doing a release build with -x and a rename."
    ": #' Let's use an expression to create a tool that converts litres per 100km to miles per gallon."
