...
simplelog = "0.12.2"
strum = "0.26.3"
thag = { path = "/Users/donf/projects/thag_rs/thag" }
tui-textarea = { version = "0.6", features = ["search"] }
*/

#![allow(clippy::uninlined_format_args)]

/// A version of `thag`'s `stdin` module for the purpose of debugging an obscure issue with the `edit`
...
//# Purpose: Debugging.
use thag::code_utils::process_expr;
use thag::colors::TUI_SELECTION_BG;
use thag::errors::ThagResult;
...
use thag::stdin::{edit_history, toml};
use thag::tui_editor::{
