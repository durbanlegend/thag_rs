...
use crate::{
    config, debug_log, generate_styles, lazy_static_var, maybe_config, vlog, BuildResult, V,
};
...
// #[cfg(not(target_os = "windows"))]
fn resolve_term_theme() -> BuildResult<TermTheme> {
...
fn maybe_restore_raw_status(raw_before: bool) -> BuildResult<()> {
...
fn restore_raw_status(raw_before: bool) -> BuildResult<()> {
