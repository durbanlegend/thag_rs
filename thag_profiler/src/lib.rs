...
/// Specialized errors for the `thag_profiler` crate.
mod errors;

/// Logging module for the `thag_profiler` crate.
mod logging;
...
/// Called by the `#[enable_profiling]` attribute macro at program termination.
///
/// # Panics
///
