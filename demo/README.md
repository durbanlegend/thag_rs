...
**Description:**  Example of a CLI using the bpaf crate instead of clap.
...
**Description:**  Prototype of configuration file implementation.
...
**Description:**  Prototype of key binding display function for `reedline` iterative processor.

**Purpose:** Prototype of `reedline` key binding display.
...
**Description:**  Example of running a single task in the background with `smol`.
...
**Description:**  Demo sorting RGB tuples using `itertools`.
...
**Description:**  Demo sorting RGB tuples using `std`.
...
**Description:**  Converts an absolute path to a relative one, relative to the current working directory.
