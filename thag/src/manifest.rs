...
pub fn capture_dep(first_line: &str) -> BuildResult<(String, String)> {
    profile!("capture_dep");
...
pub fn configure_default(build_state: &BuildState) -> BuildResult<Manifest> {
...
/// # Errors
/// Will return `Err` if there is any error parsing the default manifest.
pub fn default(source_stem: &str, gen_src_path: &str) -> BuildResult<Manifest> {
    profile!("default");
...
/// # Errors
/// Will return `Err` if there is any error parsing the default manifest.
pub fn merge(build_state: &mut BuildState, rs_source: &str) -> BuildResult<()> {
    profile!("merge");
    #[cfg(debug_assertions)]
...
) -> Result<Manifest, crate::BuildError> {
    profile!("call_omerge");
