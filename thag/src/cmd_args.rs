use crate::{
    ...
    BuildError, BuildResult, RS_SUFFIX,
};
...
pub fn validate_args(args: &Cli, proc_flags: &ProcFlags) -> BuildResult<()> {
...
pub fn get_proc_flags(args: &Cli) -> BuildResult<ProcFlags> {
    ...
    let proc_flags = {
        ...
        Ok::<ProcFlags, BuildError>(proc_flags)
    }?;
    Ok(proc_flags)
}
