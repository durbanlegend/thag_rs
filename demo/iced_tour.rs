...
impl<'a> Step {
    ...
    fn image(width: u16, filter_method: image::FilterMethod) -> Column<'a, StepMessage> {
    ...
    fn text_input(value: &str, is_secure: bool, is_showing_icon: bool) -> Column<'a, StepMessage> {
        ...
        Self::container("Text input")
            ...
            .push(
                checkbox("Show icon", is_showing_icon).on_toggle(StepMessage::ToggleTextInputIcon),
            )
            .push(
    ...
    fn debugger(debug: bool) -> Column<'a, StepMessage> {
        Self::container("Debugger")
            ...
            .push(checkbox("Explain layout", debug).on_toggle(StepMessage::DebugToggled))
...
fn ferris<'a>(width: u16, filter_method: image::FilterMethod) -> Container<'a, StepMessage> {
    container(
