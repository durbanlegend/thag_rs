...
[![Crates.io](https://img.shields.io/crates/v/thag_rs.svg)](https://img.shields.io/crates/v/thag_rs)
[![Crates.io size](https://img.shields.io/crates/size/thag_rs.svg)](https://img.shields.io/crates/size/thag_rs)
...
├── simplelog
└── full
    ├── iter                                    # Rapid iteration mode (feature name)
    │   └── tui
    │    |  ├── build
    │    |  │   ├── ast
...
cargo add thag_rs --no-default-features --features="iter,simplelog"
or
cargo add thag_rs --no-default-features --features="iter,env_logger"

Deprecated: "repl" feature still works as an alias for "iter" but will be removed in a future version.
```
