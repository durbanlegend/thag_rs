...
mod tests {
    use thag_profiler::{
        debug_log, profiling::ProfileType, warn_once,
        mem_tracking::{self, with_allocator, Allocator}
    };
    ...
    fn test_example_function_with_warn_once() {
        ...
        with_allocator(Allocator::System, || {
            ...
            thag_profiler::profiling::set_profile_type(ProfileType::Time);
            ...
            thag_profiler::profiling::set_profile_type(ProfileType::Memory);
    ...
    fn example_function_with_warn_once_id() {
        ...
        unsafe {
            ...
            if mem_tracking::warn_once_with_id(WARNING_ID, !is_mem_prof, || {
                debug_log!(
