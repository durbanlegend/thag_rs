    ...
    fn draw(&self, frame: &mut Frame) {
        ...
        let (msg, style) = match self.input_mode {
            InputMode::Normal => (
                ...
                Style::themed(Role::HD1), //.add_modifier(Modifier::RAPID_BLINK),
            ),
            InputMode::Editing => (
                vec![
                    "Press ".into(),
        ...
        let input = Paragraph::new(self.input.as_str())
            .style(match self.input_mode {
                InputMode::Normal => Style::themed(Role::Normal),
                InputMode::Editing => Style::themed(Role::Code),
            })
            .block(
                Block::bordered()
                    .title("Input")
                    .style(Style::themed(Role::HD2)),
            );
        ...
        let messages = List::new(messages)
            .block(
                Block::bordered()
                    .title("Messages")
                    .style(Style::themed(Role::EMPH)),
            )
            .style(Style::themed(Role::INFO));
