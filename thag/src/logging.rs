...
use crate::{config::maybe_config, debug_log, vlog, Cli, BuildResult};
...
pub fn set_verbosity(args: &Cli) -> BuildResult<()> {
...
pub fn set_global_verbosity(verbosity: Verbosity) -> BuildResult<()> {
