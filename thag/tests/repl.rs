...
mod tests {
    ...
    use thag::code_utils::read_file_contents;
    use thag::repl::{delete, disp_repl_banner, list, parse_line, process_source};
    #[cfg(not(windows))]
    use thag::repl::{edit, edit_history, toml, HISTORY_FILE};
    use thag::shared::BuildState;
    ...
    fn test_repl_command_print_help() {
        ...
        let mut command = thag::repl::ReplCommand::command();
    ...
    fn test_repl_edit_history() {
        ...
        use thag::MockEventReader;

        set_up();
        let build_state = thag::BuildState {
